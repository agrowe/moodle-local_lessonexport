...
*Note:* [numpages] is yet to be implemented due to a limitation at footer-printing which requires the pages to be already added in order to
know the total number of pages, whereas the footer method is called _as_ the pages are added.
